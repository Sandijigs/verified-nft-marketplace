...
const contractName = "verified-marketplace";
...
async function deployContract() {
  console.log("🚀 DEPLOYING VERIFIED-MARKETPLACE CONTRACT");
  console.log("=".repeat(60));

  // Read contract
  const contractSource = fs.readFileSync('contracts/verified-marketplace.clar', 'utf8');
